...
class PicSimilarCal:
    ...
    def bytes_to_cvimage(self, filebytes):
        # 图片字节流转换为cv image
    ...
    def runAllImageSimilaryFun(self, para1, para2):
        ...
        if para1.startswith("http"):
            ...
            img1 = self.getImageByUrl(para1)
            img1 = cv2.cvtColor(np.asarray(img1), cv2.COLOR_RGB2BGR)

            img2 = self.getImageByUrl(para2)
