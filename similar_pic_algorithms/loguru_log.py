...
logger.add('./log/log_debug.log', filter=lambda record: record["extra"]["name"] == "log_debug", rotation="10 MB", retention='10 days', level="ERROR", backtrace=True, diagnose=True)

logger.add('./log/log_data.log', filter=lambda record: record["extra"]["name"] == "log_data", rotation="10 MB", retention='10 days', level="ERROR", backtrace=True, diagnose=True)
